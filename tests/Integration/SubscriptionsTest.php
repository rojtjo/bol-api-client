...
final class SubscriptionsTest extends IntegrationTestCase
{
    /**
     * @test
     * @see https://api.bol.com/retailer/public/api/demo/v7-SUBSCRIPTIONS.html#_retrieve_push_notification_subscription_list
     */
    ...
    /**
     * @test
     * @see https://api.bol.com/retailer/public/api/demo/v7-SUBSCRIPTIONS.html#_trigger_sending_of_a_test_push_notification_for_subscription
     */
    ...
    /**
     * @test
     * @see https://api.bol.com/retailer/public/api/demo/v7-SUBSCRIPTIONS.html#_create_push_notification_subscription
     */
    ...
    /**
     * @test
     * @see https://api.bol.com/retailer/public/api/demo/v7-SUBSCRIPTIONS.html#_delete_existing_push_notification_subscription
     */
    ...
    /**
     * @test
     * @see https://api.bol.com/retailer/public/api/demo/v7-SUBSCRIPTIONS.html#_retrieve_push_notification_subscription
     */
    ...
    /**
     * @test
     * @see https://api.bol.com/retailer/public/api/demo/v7-SUBSCRIPTIONS.html#_update_existing_push_notification_subscription
     */
